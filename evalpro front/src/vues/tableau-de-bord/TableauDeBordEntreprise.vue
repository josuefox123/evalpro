<template>
  <!-- 
    TableauDeBordEntreprise : Espace réservé à l'Administrateur Entreprise (ex: TechCorp Algérie).
    Permet de piloter les campagnes de recrutement, de voir l'avancement des candidats
    et d'ajouter des recrutements.
  -->
